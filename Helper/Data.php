...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const XML_PATH_PAYMENT_GATEWAY_WS_URL             = 'https://ws.Kesterpay.net.br/pspro/v6/wsgateway/v2/';
	...
	public function __construct(
        ...
        \Kesterpay\Gateway\Helper\Logger $loggerHelper,
...
//         $this->writeLog('getPaymentHash'.json_encode($psPayment));
     ...
     * Kesterpay_Gateway_Model_Source_Customer_Address_*
     *
    ...
    {
        return $this->moduleList->getOne('Kesterpay_Gateway');
    }
    ...
    public function validateKey() {
        ...
        $url = 'http://ws.Kesterpay.net.br/pspro/v6/auth/' . $pubKey;
        $this->_curl->get($url);
    ...
    {
        $ua = 'Gateway M2/';
        $ua .= $this->moduleList->getOne('Kesterpay_Gateway')['setup_version'];
